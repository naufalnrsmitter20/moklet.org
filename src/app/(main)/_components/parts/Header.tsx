    ...
    <section className="min-h-[1000px] md:min-h-screen w-full">
      ...
      <div className="relative h-full md:h-[605px] w-full my-auto py-[82px] md:py-0">
        ...
        <Image
          ...
          height={510}
          alt="Header's image"
          className="absolute left-0 hidden lg:block top-[100px] -z-10"
        />
        <Image
          ...
          height={510}
          alt="Header's image"
          className="absolute right-0 hidden lg:block top-[80px] -z-10"
        />
        <Image
          ...
          height={510}
          alt="Header's image"
          className="absolute left-0 block lg:hidden top-[550px] -z-10"
        />
        <Image
          ...
          height={510}
          alt="Header's image"
          className="absolute right-0 block lg:hidden top-[400px] -z-10"
        />
      </div>
    </section>
  );
